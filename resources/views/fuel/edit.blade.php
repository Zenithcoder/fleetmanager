        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card card-solid" >
              ...
              <div class="card-body">
                <input type="radio" name="fuel_from" class="flat-red" value="Fuel Tank" @if($data->fuel_from == "Fuel Tank") checked @endif>
                {!! Form::label('fuel_from', __('fleet.fuel_tank'), ['class' => 'form-label']) !!}
                <br>
                <input type="radio" name="fuel_from" class="flat-red" value="N/D"  @if($data->fuel_from == "N/D") checked @endif >
                {!! Form::label('fuel_from',  __('fleet.nd'), ['class' => 'form-label']) !!}
                <br>
                <input type="radio" name="fuel_from" class="flat-red" value="Vendor" @if($data->fuel_from == "Vendor") checked @endif>
            ...
            <div class="card card-solid" >
              ...
              <div class="card-body">
                <div class="form-group">
                  {!! Form::label('qty',__('fleet.qty').' (Gal/liter)', ['class' => 'form-label']) !!}
