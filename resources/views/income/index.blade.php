    ...
    <div class="card card-success">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-2">
            <select id="vehicle_id" name="vehicle_id" class="form-control vehicles" style="width: 150px" required>
          ...
          <div class="col-md-2" style=" margin-top: 5px;">
            <select id="income_type" name="income_type" class="form-control vehicles" style="width: 150px;" required>
      ...
      <div class="card-header">
        <div class="panel-heading">
          <div class="row">
            <div class="col-md-4">
              <h3 class="card-title">
                @lang('fleet.todayIncome'): <strong><span id="total_today"> {{ $total}} </span> </strong>
              </h3>
            </div>
