...
<head>
  ...
  <link rel="icon" href="{{ asset('assets/images/'. Hyvikk::get('icon_img') ) }}" type="image/png">
  <!-- Font Awesome -->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        @if (!Auth::guest() &&  Auth::user()->user_type!="D" && Auth::user()->user_type != "C" )
            ...
            @php($active="")
            @endif
          @if(in_array(0,$modules)) <li class="nav-item has-treeview {{$class}}">
            <a href="#" class="nav-link {{$active}}">
          ...
          @if(in_array(6,$modules)) <li class="nav-item has-treeview {{$class}}">
           ...
           @if(in_array(14,$modules))<li class="nav-item has-treeview {{$class}}">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('parts.index') }}" class="nav-link @if(Request::is('admin/parts')) active @endif">
