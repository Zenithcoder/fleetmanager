...
class BookingQuotationModel extends Model {
	...
	protected $fillable = [
		'customer_id', 'vehicle_id', 'user_id', 'pickup', 'dropoff', 'pickup_addr', 'dest_addr', 'travellers', 'status', 'comment', 'dropoff_time', 'driver_id', 'note', 'day', 'mileage', 'waiting_time', 'total',
	];
