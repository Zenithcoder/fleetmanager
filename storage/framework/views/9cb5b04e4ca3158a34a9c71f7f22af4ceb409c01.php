...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <?php if(!Auth::guest() &&  Auth::user()->user_type!="D" && Auth::user()->user_type != "C" ): ?>
            ...
            <?php ($active=""); ?>
            <?php endif; ?>
          <?php if(in_array(0,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
          ...
          <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
           ...
           <?php if(in_array(14,$modules)): ?><li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('parts.index')); ?>" class="nav-link <?php if(Request::is('admin/parts')): ?> active <?php endif; ?>">
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline-block">
      <b><?php echo app('translator')->getFromJson('fleet.version'); ?></b> 4.0.1
    </div>
  </footer>-->
...
</html><?php /**PATH C:\Users\oawonusi.HQ\Documents\ICS\FleetManagerv4\resources\views/layouts/app.blade.php ENDPATH**/ ?>