...
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <div class="card-body">
        <?php echo Form::open(['route' => 'dreports.monthly','method'=>'post','class'=>'form-inline']); ?>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Chart - <?php echo app('translator')->getFromJson('fleet.income'); ?></h3>
              </div>
              <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oawonusi.HQ\Documents\ICS\FleetManagerv4\resources\views/drivers/monthly.blade.php ENDPATH**/ ?>