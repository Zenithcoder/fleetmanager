    ...
    <div class="card-body login-card-body">
      ...
      <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block btn-flat">xxSign In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
...
</html><?php /**PATH C:\Users\oawonusi.HQ\Documents\ICS\FleetManagerv4\resources\views/auth/login.blade.php ENDPATH**/ ?>