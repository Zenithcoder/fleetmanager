          ...
          <table class="table table-responsive display" id="data_table1" style="padding-bottom: 35px; width: 100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <?php echo e(Hyvikk::get('currency')); ?> <?php echo e($row->total); ?>
                ...
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu custom" role="menu">
                    <?php if($row->status==0): ?><a class="dropdown-item" href="<?php echo e(url('admin/bookings/'.$row->id.'/edit')); ?>"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> <?php echo app('translator')->getFromJson('fleet.edit'); ?></a><?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oawonusi.HQ\Documents\ICS\FleetManagerv4\resources\views/bookings/index.blade.php ENDPATH**/ ?>